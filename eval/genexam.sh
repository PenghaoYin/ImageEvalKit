...
$CONDA_BASE/envs/${EVAL_ENV}/bin/python run_eval_multiprocess.py --data_dir ./data/ --img_save_dir ${RESULT_DIR}/genexam/images --eval_save_dir ${RESULT_DIR}/genexam/eval_results
