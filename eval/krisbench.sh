...
# If previous output results exist, delete them to avoid mixing results
rm -rf results/*
...
$CONDA_BASE/envs/${EVAL_ENV}/bin/python metrics_multi_element_robust.py --models ${MODEL_NAME} # Use the modified version
$CONDA_BASE/envs/${EVAL_ENV}/bin/python metrics_temporal_prediction_robust.py --models ${MODEL_NAME} # Use the modified version
