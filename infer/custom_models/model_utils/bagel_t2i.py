...
class BagelT2I:
    ...
    def generate(self, prompt, seed=42):
        self.set_seed(seed) # Set different random seed for different runs
        ...
        output_dict = self.inferencer(text=prompt, think=self.generate_with_think, **inference_hyper)
...
if __name__ == '__main__':
    ...
    output_bagel.save('test_output/output_bagel_think_t2i.png')